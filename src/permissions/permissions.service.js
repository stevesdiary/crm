...
var PermissionsService = function () {
    ...
    var PermissionsService = _classThis = /** @class */ (function () {
        ...
        PermissionsService_1.prototype.seedPermissions = function () {
            return __awaiter(this, void 0, void 0, function () {
                var permissions, _i, permissions_1, permission;
        ...
        PermissionsService_1.prototype.createDefaultRoles = function (tenantId) {
            return __awaiter(this, void 0, void 0, function () {
                var adminRole, salesRole, supportRole, allPermissions, salesPermissions, supportPermissions;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.role.create({
                                data: {
                                    tenantId: tenantId,
                                    name: 'admin',
                        ...
                        case 6:
                            salesPermissions = _a.sent();
                            return [4 /*yield*/, this.prisma.rolePermission.createMany({
                                    data: salesPermissions.map(function (p) { return ({
                                        roleId: salesRole.id,
                                        permissionId: p.id,
                                    }); }),
                                })];
                        ...
                        case 8:
                            supportPermissions = _a.sent();
                            return [4 /*yield*/, this.prisma.rolePermission.createMany({
                                    data: supportPermissions.map(function (p) { return ({
                        ...
                        case 9:
                            _a.sent();
                            return [2 /*return*/, { adminRole: adminRole, salesRole: salesRole, supportRole: supportRole }];
                    }
                });
            });
        };
